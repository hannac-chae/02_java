...
public class GenericListTest {
	...
	public static void main(String[] args) {
		...
		// (2) Book 만 저장하는 리스트에 add(E)
		books.add(new Book(1, "9788936433598", "채식주의자"
				            , "한강", "창비", 247, 10800, 10));
		books.add(new Book(2, "9791159039690", "어린왕자(초판본)"
				            , "생텍쥐페리", "더스토리", 150, 8820, 5));
		books.add(new Book(3, "9791190182645", "제 인생에 답이 없어요"
				            , "선바", "위즈덤하우스", 192, 10800, 3));
		books.add(new Book(4, "9791196394509", "죽고 싶지만 떡볶이는 먹고 싶어"
				            , "백세희", "흔", 208, 12420, 2));
		books.add(new Book(5, "9788956055466", "책은 도끼다"
